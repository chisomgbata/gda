                ...
                <div class="w-full lg:w-1/2 px-4">
                    <div class="lg:max-w-md p-6 lg:px-10 lg:py-12 bg-white text-center border rounded-xl">
                        <form action="{{route('register')}}" method="POST">
                            ...
                            <h3 class="mb-12 text-3xl font-semibold font-heading"> إنشاء حساب جديد</h3>
                            <div class="relative flex flex-wrap mb-6">
                                ...
                                <span
                                    class="absolute top-0 left-0 ml-4 -mt-2 px-1 inline-block bg-white text-gray-500 text-xs">Your Name</span>
                            </div>
                            <div class="relative flex flex-wrap mb-6">
                            ...
                            <div class="relative flex flex-wrap mb-6">
                                ...
                                <span
                                    class="absolute top-0 left-0 ml-4 -mt-2 px-1 inline-block bg-white text-gray-500 text-xs">Repeat password</span>
                            </div>
