        ...
        <div class="flex flex-wrap justify-center lg:justify-start items-center -mx-4">
            ...
            <div class="relative w-full md:w-1/2 px-8">
                <img class="hidden lg:block lg:absolute top-0 right-0 z-10 lg:mt-28"
                     src="zeus-assets/icons/dots/yellow-dot-right-shield.svg" alt=""><img
                    class="relative shadow-xl rounded-2xl"
                    src="https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?crop=entropy&amp;cs=srgb&amp;fm=jpg&amp;ixid=M3wzMzIzMzB8MHwxfHNlYXJjaHw4fHxnYW1lfGVufDB8fHx8MTcxMjYxMzUwMXww&amp;ixlib=rb-4.0.3&amp;q=85&amp;w=1920"
                    alt=""><img class="hidden lg:block lg:absolute bottom-0 lg:left-0 lg:ml-6 lg:mb-20"
